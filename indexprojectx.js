...
let fetchdata=async ()=>
    {
       let data1=await fetch("https://newsapi.org/v2/everything?domains=wsj.com&apiKey=ee9ffbd35cd8405b9f09527d74553d5c")
...
let fetchdata2=async ()=>
    {
       let data1=await fetch("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=ee9ffbd35cd8405b9f09527d74553d5c")
       let data2=await data1.json()
       console.log(data2)
